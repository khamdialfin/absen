<x-layouts.app title="Rekapan Absensi">
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-3 mb-4 d-print-none">
        <div>
            <h1 class="h4 fw-bold mb-1">Rekapan Absensi</h1>
            <p class="text-muted small mb-0">Laporan kehadiran siswa per hari</p>
        </div>

        <div class="d-flex flex-wrap align-items-center gap-2">
            <a href="{{ route('sekertaris.scan') }}" class="btn btn-outline-secondary btn-sm fw-semibold">
                <i class="bi bi-qr-code-scan me-1"></i>Scan QR
            </a>
            <a href="{{ route('sekertaris.recap.export', request()->all()) }}" class="btn btn-success btn-sm fw-semibold">
    ...
    <div class="card border-0 shadow-sm mb-4 d-print-none">
        <div class="card-body py-3">
            <form action="{{ route('sekertaris.recap') }}" method="GET">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                ...
                                <p class="text-muted mb-0" style="font-size:0.75rem;">Belum ada rekaman absensi untuk periode ini.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
