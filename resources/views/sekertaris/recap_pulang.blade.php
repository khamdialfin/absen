<x-layouts.app title="Rekap Absensi Pulang">
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-3 mb-4 d-print-none">
        <div>
            <h1 class="h4 fw-bold mb-1">Rekap Absensi Pulang</h1>
            <p class="text-muted small mb-0">Laporan khusus jam pulang siswa</p>
        </div>
    ...
    <div class="card border-0 shadow-sm mb-4 d-print-none">
        <div class="card-body py-3">
            <form action="{{ route('sekertaris.recap.pulang') }}" method="GET">
    ...
    <div class="d-none d-print-block mb-3">
        <h1 class="h5 fw-bold">Rekap Absensi Pulang</h1>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <span class="fs-2 text-muted"><i class="bi bi-box-arrow-right"></i></span>
                                <p class="small fw-medium mt-2 mb-0">Tidak ada data absensi pulang</p>
                                <p class="text-muted mb-0" style="font-size:0.75rem;">Belum ada rekaman jam pulang untuk periode ini.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
